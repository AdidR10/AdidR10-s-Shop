			...
			<div className='cart-page container-fluid container-min-max-width'>
				...
				<ul>
					...
					<li>
						<p>
							...
							&quot;Our&quot; in this Agreement) refers to adid's Shop.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to adid's Shop, accessible from{' '}
							<a href='www.adids-shop.com' rel='external nofollow noopener' target='_blank'>
								www.adids-shop.com
							</a>
						</p>
					</li>
				...
				<ul>
					<li>
						...
						<a href='www.adids-shop.com/contact' rel='external nofollow noopener' target='_blank'>
							www.adids-shop.com/contact
						</a>
					</li>
				</ul>
			</div>
